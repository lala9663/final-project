...
<body>
	...
	<div style="margin:0 auto; width:100%;" id="list_wrap">
		<div id="ticket_wrap">
			...
			<button class="no-print" onclick="location.href='${pageContext.request.contextPath}/user/TicketCancelOk.us?ticketingid=${ticket.ticketingid}&seatid=${ticket.seatid}';">예매취소</button>
