...
<html lang="ko">
  <head>
    ...
    <link
      ...
      type="text/css"
    />
    <link rel="stylesheet" href="https://t1.daumcdn.net/cfile/tistory/234EF6505802210005?original" />
	...
	<div id="wrap">
		<table class="title">
			<tr align="center" valign="middle">
				<td><h3>${movietitle} 상영시간 추가</h3></td>
			</tr>
		</table>
		<form id="ticketingTimeForm" method="post" name="ticketingTimeForm" action="${cp}/ticketing/TicketingTimeWriteOk.ti?movietitle=${movietitle}">
			<input type="hidden" name="movietitle" value="${movietitle}" >
			<table border="1" style="border-collapse: collapse;">
				<tr height="30px">
					<th align="center" width="150px">상영시작시간</th>
					<td>
						<input type="text" id="starttime" name="starttime" value="" size="50" maxlength="50" placeholder="상영시작시간을 입력하세요" />
					</td>
				</tr>
				<tr height="30px">
					<th align="center" width="150px">상영종료시간</th>
					<td>
						<input type="text" id="endtime" name="endtime" value="" size="50" maxlength="50" placeholder="상영종료시간을 입력하세요" />
					</td>
				</tr>
				<tr height="30px">
