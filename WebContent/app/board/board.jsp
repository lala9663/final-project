      ...
      <div class="container">
		...
		<div id="help">
	      	<div class="help_box">
				...
				<%-- <div class="help_img2">
					<a href="${pageContext.request.contextPath}/per/Perlist.pe">
						<img src="${pageContext.request.contextPath}/app/board/assets/bo_img/adminper.png" alt="관리자권한요청">
						<strong>관리자 권한 신청</strong>
					</a>	    				
			    </div> --%>
